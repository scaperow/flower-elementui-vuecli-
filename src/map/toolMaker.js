 ...
 * @param {*} meshColor 
 */
let createMesh = function (meshColor) {
  return $(go.Panel, "Grid",
    ...
    $(go.Shape, "LineH", { strokeWidth: 0.5, interval: 1, stroke: meshColor }),
    $(go.Shape, "LineH", { strokeWidth: 0.5, interval: 10, stroke: meshColor }),
    $(go.Shape, "LineV", { strokeWidth: 0.5, interval: 1, stroke: meshColor }),
    $(go.Shape, "LineV", { strokeWidth: 0.5, interval: 10, stroke: meshColor })
  )
}
 ...
 * @param {*} ruleColor 
 */
let createRule = function (ruleColor) {
  var gradScaleHoriz = $(go.Node, "Graduated",
    ...
    $(go.Shape, { name: 'CONTAINER', geometryString: "M0 0 H1920", stroke: ruleColor }),
    $(go.Shape, { geometryString: "M0 0 V3", interval: 1, stroke: ruleColor }),
    $(go.Shape, { geometryString: "M0 0 V15", interval: 5, stroke: ruleColor }),
    $(go.TextBlock,
      {
...
class Maker {
  constructor(style, canvas) {
    this.style = style
    this.canvas = canvas
    var meshColor = _.get(this.style, 'root.meshColor')
    var ruleColor = _.get(this.style, 'root.ruleColor')
  ...
  makeRelinkTool () {
    return {
      ...
      "relinkingTool.fromHandleArchetype":
        $(go.Shape, "Diamond", { segmentIndex: 0, cursor: "pointer", desiredSize: new go.Size(12, 12), fill: "tomato", stroke: "deepskyblue" }),
      "relinkingTool.toHandleArchetype":
        $(go.Shape, "Diamond", { segmentIndex: -1, cursor: "pointer", desiredSize: new go.Size(12, 12), fill: "darkred", stroke: "tomato" }),
      "linkReshapingTool.handleArchetype":
        $(go.Shape, "Diamond", { desiredSize: new go.Size(12, 12), fill: "lightblue", stroke: "deepskyblue" })
    }
  }
