...
import { HoverIcons, Graph, Graphics } from "./Graph"


const { mxClient, mxDragSource, mxEventObject, mxPoint, mxStencilRegistry, mxConstants, mxRectangle, mxUtils, mxGeometry, mxEvent, mxCell, mxResources, mxDictionary, mxCodecRegistry, mxObjectCodec, mxEventSource, mxPopupMenu, mxConnectionHandler } = Graphics;
 ...
 */
const Sidebar = function (editorUi, container) {
