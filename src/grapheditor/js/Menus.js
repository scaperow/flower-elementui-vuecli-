...
const { mxUndoManager, mxEventObject, mxEvent, mxClient, mxUtils, mxResources, mxCodec, mxEventSource, mxPopupMenu, mxGraphView, mxGraphHandler, mxConnectionHandler, mxPopupMenuHandler } = Graphics;
 ...
 */
const Menubar = function (editorUi, container) {
  this.editorUi = editorUi;
 ...
 */
const Menu = function (funct, enabled) {
