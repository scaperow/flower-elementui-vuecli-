...
import { Graph, Graphics, HoverIcons } from './Graph'
...
const { mxClient, mxUtils, mxEventObject, mxRectangle, mxPoint, mxKeyHandler, mxEvent, mxClipboard, mxResources, mxCodecRegistry, mxObjectCodec, mxEventSource, mxPopupMenu, mxConstants, mxConnectionHandler } = Graphics;
