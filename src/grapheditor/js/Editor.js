...
import { Graph, Graphics } from "./Graph";
import {
  urlParams,
  IMAGE_PATH,
} from './Constant'
const { mxGraph, mxPoint, mxConstants, mxRectangleShape, mxRectangle, mxEventObject, mxUndoManager, mxEvent, mxClient, mxUtils, mxResources, mxCodec, mxEventSource, mxPopupMenu, mxGraphView, mxGraphHandler, mxConnectionHandler, mxPopupMenuHandler } = Graphics;
 ...
 */
const Dialog = function (editorUi, elt, w, h, modal, closable, onClose, noScroll, transparent, onResize) {
  var dx = 0;
...
PrintDialog.prototype.create = function (editorUi) {
  ...
  pageCountInput.style.width = '90px';
