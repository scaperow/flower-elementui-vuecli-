...
const { mxEventObject, mxEvent, mxClient, mxUtils, mxResources, mxConstants, mxEventSource, mxPopupMenu, mxGraphView, mxGraphHandler, mxConnectionHandler, mxPopupMenuHandler } = Graphics;
