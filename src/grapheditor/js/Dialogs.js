 ...
 */
const ColorDialog = function (editorUi, color, apply, cancelFn) {
 ...
 */
const FilenameDialog = function (editorUi, filename, buttonText, fn, label, validateFn, content, helpLink, closeOnBtn, cancelFn, hints) {
 ...
 */
const TextareaDialog = function (editorUi, title, url, fn, cancelFn, cancelTitle, w, h, addButtons, noHide, noWrap, applyTitle) {
  w = (w != null) ? w : 300;
  h = (h != null) ? h : 120;
 ...
 */
const EditDiagramDialog = function (editorUi) {
  var div = document.createElement('div');
 ...
 */
const ExportDialog = function (editorUi) {
  var graph = editorUi.editor.graph;
 ...
 */
const EditDataDialog = function (ui, cell) {
  var div = document.createElement('div');
...
export default {
  LinkDialog, OutlineWindow, LayersWindow, ExportDialog,
  TextareaDialog, ColorDialog, OpenDialog, AboutDialog
}