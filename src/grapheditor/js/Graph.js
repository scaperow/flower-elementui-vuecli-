...
import language from "!raw-loader!@/grapheditor/langs/zh.txt";
...
const Graphics = new MxGraph();

let { mxGraph,mxImageShape, mxStackLayout , mxVertexHandler,mxCellState , mxPolyline,mxEventObject , mxValueChange, mxDragSource, mxPanningHandler, mxCellEditorGetCurrentValue, mxOutline, mxCellEditorGetInitialValue, mxConstraintHandler, mxGuide, mxRubberband, mxEdgeHandler, mxEvent, mxCellEditor, mxLayoutManager, mxClient, mxRectangle, mxCellRenderer, mxImage, mxConnector, mxStencil, mxStencilRegistry, mxCellHighlight, mxSvgCanvas2D, mxPoint, mxShape, mxUtils, mxText, mxGraphModel, mxResources, mxConstants, mxCodec, mxEventSource, mxPopupMenu, mxGraphView, mxGraphHandler, mxConnectionHandler, mxPopupMenuHandler } = Graphics;

mxResources.parse(language);
...
Graph.prototype.sanitizeHtml = function (value, editing) {
  ...
  return sanitizeHtml(value, urlX, idX);
};
